...
参照*geeksforgeeks*网站给出的实例程序，它包含了设计图类，邻接表设计，BFS设计以及最终双向搜索算法的实现， 我对代码进行了重构，放到我的[Github仓库](https://github.com/SongShaopu1998/bidirectional-search)。

### MST problem

什么是最小生成树？**构造联通网的最小代价生成树成为最小生成树**，
