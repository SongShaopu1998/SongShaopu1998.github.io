...
<img src="/home/shaopu/.config/Typora/typora-user-images/image-20220111202017570.png" alt="image-20220111202017570" style="zoom: 33%;" />
...
2. 我们来思考，是否能够借助第一条指令**EX**之后的结果，利用逻辑电路把已经计算好但没有储存在寄存器或者内存中的结果传递给需要他们的指令？这就是我们的第二种思路–**Forwarding**
