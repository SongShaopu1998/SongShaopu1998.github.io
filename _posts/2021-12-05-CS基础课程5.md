...
随着`stride`的变大，根据我们对**L1 cache**的分析，会产生更多的`conflict miss`，于是处理器就会想要前往**L2 cache**中寻找数据，一开始还是可以找到的，后来随着`stride`的继续增大，**L2 cache**中也找不到了，于是**AMAT**进一步增长。
...
<img src="https://upload.wikimedia.org/wikipedia/commons/6/6f/CPU缓存_03_受害者缓存.png" alt="img" style="zoom: 67%;" />
...
<img src="https://shaopu-blog.oss-cn-beijing.aliyuncs.com/img/image-20220124151029064.png" alt="image-20220124151029064" style="zoom:50%;" />
